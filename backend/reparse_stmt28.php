...
echo "🔄 RE-PARSING STATEMENT 28 WITH NEW CODE\n\n";

$stmt = \App\Models\BankStatement::find(28);

echo "Statement: {$stmt->filename}\n";
echo "PDF Expected: KES 6,081,513\n\n";
...
if ($dupCount === 0) {
    ...
    echo "  ❌ {$dupCount} DUPLICATES DETECTED (bug!)\n";
}
...
if ($dupCount === 0 && $diff < 500) {
    echo "✅ PERFECT! Statement 28 re-parsed correctly with NO duplicates\n";
} else {
    echo "⚠️  Re-parsed but may need further investigation\n";
}
